    ...
    remoteJid: 'status@broadcast' } : {
       ...
       'productImage':{ 
         ...
         'jpegThumbnail': fs.readFileSync(`./stik/fake.jpg`)
            ...
            'title': `${watermark}`, 
            'description': 'devil bot', 
            'currencyCode': 'USD', 
            'priceAmount1000': '50000000', 
            'retailerId': 'devil bot', 
            'productImageCount': 1
            }, 
               'businessOwnerJid': `6281274928366@s.whatsapp.net`
               }
            }
        }
...
*D E V I L   B O T*`
	    ...
	    reply(`*Terimakasih Telah Terdaftar Di devil bot*`)
	}, 2000)
	}
	    // Auto Read
  ...
  descOwner
    ...
    : '*Desc diubah oleh* : -'
        ...
        case 'credits': {
			...
			let devil = '6288215463787@s.whatsapp.net' //kang recode:v
